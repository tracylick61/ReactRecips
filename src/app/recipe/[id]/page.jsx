import { getMealById } from '@/app/lib/api'
...
export default async function RecipePage({ params }) {
    ...
    <div className="p-8 text-center text-red-500">
        ...
        <Link href="/" lassName="btn block mb-4">← Go Home</Link>
    </div>
    )
}
    ...
    <Link href="/" className="btn block mb-4">← Go Back</Link>
    ...
    <p className=" text-gray-700 white space-pre-line mb-6">
    ...
    <table className="w-full mt-2 mb-6 table-auto border-collapse border border-gray-300">
        <thead>
            <tr className="bg-gray-100">
                <th className="border border-gray-300 px-4 py2 text-left">Ингредиент</th>
