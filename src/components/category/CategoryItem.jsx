...
export function CategoryItem({strCategory, strCategoryThumb, strCategoryDescription }) {
    return(
        <div className="rounded-lg overflow-hidden shadow-md bg-white" key={strCategory}>
            ...
            <div className="px-4 pb-4">
                <Link href={`/category/${strCategory}`} className="btn-accent inline-block hover:bg-orange-700">
                    Watch category
                </Link>
            </div>
        </div>
